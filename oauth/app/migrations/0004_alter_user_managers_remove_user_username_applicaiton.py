# Generated by Django 4.1.9 on 2023-05-26 13:55

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import oauth.app.models
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0003_remove_user_address_alter_user_email_and_more'),
    ]
    ...
    operations = [
        migrations.AlterModelManagers(
            name='user',
            managers=[
                ('objects', oauth.app.models.UserManager()),
            ],
        ),
